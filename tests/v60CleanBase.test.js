...
assert.ok(
  exists('scripts/run-ci-tests-v060.js')
);

assert.ok(
  exists('scripts/build-android-js-v060.js')
);

assert.ok(
  exists('scripts/v60-audit.js')
);
...
assert.ok(
  !/\bgeometry\b/.test(block)
);

console.log(
  'v60CleanBase.test.js PASS'
);
