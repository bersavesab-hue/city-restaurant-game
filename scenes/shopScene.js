...
const propertyAdapterV02 =
  require('../property/propertyAdapterV02.js');
...
class ShopScene {
  ...
  makeLiveListing(
    ...
    const depositPaymentCount =
      (
        Number(
          enrichedItem.depositMonths
        ) ||
        0
      ) +
      (
        Number(
          enrichedItem.paymentMonths
        ) ||
        1
      );
      ...
      Math.max(
        ...
        Math.round(
          ...
          (
            (
              Number(
                enrichedItem.askingMonthlyRent
              ) ||
              0
            ) -
            (
              Number(
                enrichedItem.monthlyRent
              ) ||
              0
            )
          ) *
          ...
          (
            (
              Number(
                enrichedItem.askingTransferFee
              ) ||
              0
            ) -
            (
              Number(
                enrichedItem.transferFee
              ) ||
              0
            )
          )
